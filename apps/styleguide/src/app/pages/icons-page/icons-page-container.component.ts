...
export class IconsPageContainerComponent {
  items: ReadonlyMap<DsIconCategory, DsIconName[]>;
  ...
  private getItems(): ReadonlyMap<DsIconCategory, DsIconName[]> {
    const items: Map<DsIconCategory, DsIconName[]> = new Map();
